...
(function () {
  ...
  var TOURS = {
    ...
    /* ─── MEMBER DASHBOARD ─────────────────────────────────────── */
    'app.html': [
      { sel: '.sidebar',         pos: 'right',  title: '🏙️ PHX App Navigation',                desc: 'PHX Music is live now — 14 local artists, fan-powered payouts, 30-second stream tracking. Events, Eats, Audio, Drops, and Cuts are all in the pipeline for Q3–Q4 2026.' },
      ...
      { sel: '#v-home',          view: 'home',      pos: 'right', title: '🏠 City Feed — Home',           desc: 'Live stream count, PHX artist roster size, fan-powered payout rate, and the city feed of posts from creators. Plus a trending tracks chart showing what\'s moving.' },
      { sel: '#v-discover',      view: 'discover',  pos: 'right', title: '🔍 Discover — Platform Roadmap', desc: 'Music is lit up and live. Every other category shows its Q3/Q4 2026 launch date. Tap any live section to jump straight in.' },
      { sel: '#v-music',         view: 'music',     pos: 'right', title: '🎵 PHX Music — Fully Live',      desc: 'The full music experience: expanded player with queue, 30-second stream tracking, artist spotlight, fan-powered payout breakdown, and the PHX roster. Live now.' },
      { sel: '.music-stats-bar', view: 'music',     pos: 'bottom', title: '📡 Live Platform Stats',        desc: 'Total PHX streams (updates as you play), artist count, and the fan-powered per-stream rate — $0.012, which is 3× Spotify\'s average. These numbers are real.' },
      { sel: '.music-player-expanded', view: 'music', pos: 'bottom', title: '🎧 Expanded Player + Queue', desc: 'Bigger now-playing screen with live stream count, full track/artist/album details, and an always-visible queue — no hidden bottom sheets. Apple Music\'s approach beats Spotify\'s here.' },
      { sel: '.fan-payout-card', view: 'music',     pos: 'left',  title: '💚 Fan-Powered Payouts',         desc: 'Your $15/mo goes directly to artists you actually listen to — not into a shared pool with 640M other subscribers. Murkemz earns $10.32/mo from Alex\'s sub alone. Transparent and fair.' },
      { sel: '.mini-player',     pos: 'top',         title: '🎧 Persistent Mini Player',         desc: 'Music keeps playing as you navigate. Shows 30-second stream tracking status — when a stream is counted you\'ll see the confirmation here.' },
      { sel: '#v-events',        view: 'events',    pos: 'right', title: '🎟️ Events — Coming Q3 2026',    desc: 'Full live-show calendar, PHX Pass ticketing perks, and VIP access built in. Founding partner events confirmed: Rebel Lounge, Trill, Roosevelt Row.' },
      { sel: '#v-eats',          view: 'eats',      pos: 'right', title: '🍽️ Eats — Coming Q3 2026',      desc: 'Founding restaurants confirmed: Bacanora, Chilte, Valentine, Barrio Café. PHX Pass discounts applied automatically — show your pass, instant perk.' },
      { sel: '#v-audio',         view: 'audio',     pos: 'right', title: '🎙️ Audio — Coming Q4 2026',     desc: 'Local podcasts: Murk Report, 602 Sports Talk, Desert Table, Shop Talk, PHX Hustle. All Phoenix voices, all in one place. Ad-free for Native members.' },
      { sel: '#v-drops',         view: 'drops',     pos: 'right', title: '👕 Drops — Coming Q3 2026',     desc: 'Limited streetwear drops from Manor PHX, Onassis Krown, and more. Insider members get notified first. PHX App × Murkemz collab cap already confirmed.' },
      { sel: '#v-cuts',          view: 'cuts',      pos: 'right', title: '✂️ Cuts — Coming Q4 2026',      desc: 'Partner barbershops with in-app booking and PHX Pass discounts. Cuts & Culture PHX, Desert Edge, 602 Fades all confirmed as founding partners.' },
      { sel: '#v-mypass',        view: 'mypass',    pos: 'right', title: '🪪 My PHX Pass Card',            desc: 'Your digital membership card. Shows your fan-powered impact — how much of your subscription goes to artists you listen to. Add to Apple or Google Wallet.' },
      { sel: '#v-profile',       view: 'profile',   pos: 'right', title: '👤 Your City Profile',           desc: 'Your member profile with listening activity chart. See your session stream count and how your subscription is split across the PHX Music roster.' },
    ],
