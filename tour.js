...
(function () {
  ...
  var TOURS = {
    ...
    'app.html': [
      ...
      { sel: '.music-stats-bar', view: 'music',     pos: 'bottom', title: '📡 Live Platform Stats',        desc: 'Total PHX streams (updates as you play), the artist count, and monthly artist payouts powered by your listening. These numbers are real.' },
      ...
      { sel: '.fan-payout-card', view: 'music',     pos: 'left',  title: '💚 Your Listening Impact',       desc: 'Your listening directly supports the Phoenix artists you play — not a global pool where megastars take everything. See where your listening went each month.' },
      ...
      { sel: '#v-mypass',        view: 'mypass',    pos: 'right', title: '🪪 My PHX Pass Card',            desc: 'Your digital membership card. Shows your listening impact — which Phoenix artists your plays support each month. Add to Apple or Google Wallet.' },
      { sel: '#v-profile',       view: 'profile',   pos: 'right', title: '👤 Your City Profile',           desc: 'Your member profile with listening activity chart, your @username, and your Pages — run an artist page, restaurant, or brand from one account.' },
    ],
